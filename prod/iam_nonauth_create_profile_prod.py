# FILE: iam_nonauth_create_profile_prod.py
# DESC: use Selenium + Python to automate  NonAuth Create Profile (Find My Data) in PROD
...
# ---------- ---------- ---------- ---------- ----------
WAIT_TIMEOUT = 30 
IAM_FINDMYDATA_URL_PROD = 'https://accounts.intuit.com/app/findmydata'
NONAUTH_TEST_PERSON = {
...
while True:
    try:
        browser.get(IAM_FINDMYDATA_URL_PROD)
